...
const navLinks = [
  ...
  svg: (
    ...
    viewBox="0 0 24 24"
  > 
    <path d="M20 2H4a2 2 0 0 0-2 2v16c0 .55.45 1 1 1s1-.45 1-1V4h16v16h-7v2h7a2 2 0 0 0 2-2V4a2 2 0 0 0-2-2ZM6 6v6l2.5-1.5L11 12V6H6Zm6 7a5 5 0 1 1-6 4.9A5 5 0 0 1 12 13Zm0 2a3 3 0 1 0 3 3 3 3 0 0 0-3-3Z"/>
  </svg>
  ),
  text: "Certificates",
  },
  ...
  return (
    <header className="md:flex">
      ...
      >
        ...
        >
          Myself
          <span className="text-marrsgreen dark:text-carrigreen">.Sanket</span>
        </Link>
