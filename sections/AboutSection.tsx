...
import satNaing from "../public/whoami.jpg";
...
const educationInfo = [
  {
    id: 1,
    title: "B.Sc (ENTIRE COMPUTER SCIENCE)",
  ...
  },
  {
    id: 2,
    title: "HSC",
    subTitle: "SVM, Sangola | 2022 - 2023",
    list: [
      "Mejor's : Physics, Chemistry, Mathematics ",
      "Passed HSC with overall Merit",
    ],
  },
  {
    id: 3,
    title: "",
    subTitle: "~ outside academics",
    list: ["Got gold medal in drill and silver medal in riffle shooting.",
            "State level basketball player",
            "love reading books, listening music and writing poems and raps",
    ],
  },
];
