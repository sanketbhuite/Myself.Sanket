    ...
    >
      ...
      <div className="lg:basis-2/3 z-10 relative">
        ...
        <div className="mt-2 my-4 md:mb-8">
          <p className="mb-1">
            love for web development, programming, and technology.
          </p>
          <p>
a final-year B.Sc. (ECS) student passionate about web development, programming, cybersecurity, and data analysis. I've built real-world projects and have hands-on experience in React, PHP, Python, and more          </p>
        </div>
        <LinkButton href="mailto:work.sanketbhuite@outlook.com">
          Contact me!
        </LinkButton>
      </div>
      <a
